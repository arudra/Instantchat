...
public class DisplayServlet extends HttpServlet
{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException 
	{
	    ...
	    if (userService.getCurrentUser() == null) 
	    {
	    	...
	    	out.println("	  <p><button id='signIn' onclick=\"window.location.assign('" + userService.createLoginURL(getLoginURL(req, chatroomKey)) +"')\">Sign In</button></p>");
	    	out.println("	  </div>");
	    	out.println("      </tr>");
	    	out.println("    </table>");
	    	out.println("  </div>");
		...
		out.println("}");
		out.println("#submit, #join, #search, #edit {");
		out.println("  text-decoration:none;");
		out.println("  width:100%;");
		out.println("  text-align:center;");
		out.println("  display:block;");
		...
		out.println("<hr>");
		out.println("<input id='roomname' name='roomname' placeholder='Chat Room Name' type='text' onkeypress=\"enterSendnewroomform(event)\">");
		out.println("<input id='password' name='password' placeholder='Chat Room Password' type='text' onkeypress=\"enterSendnewroomform(event)\">");
		out.println("<p></p>");
		...
		out.println("<input id='roompass' style='width:300px;' name='password' placeholder='Chat Room Password' type='text' onkeypress=\"enterSendpasswordform(event)\">");
		out.println("<p></p>");
		...
		out.println("<hr>");
		out.println("<input id='searchuserinput' style='width:300px;' name='user' placeholder='Search User ID' type='text' onkeypress=\"enterSendsearchuserform(event)\">");
		out.println("<p></p>");
		...
		out.println("<hr>");
		out.println("<input id='Firstname' name='firstname' placeholder='Enter First Name' type='text' onkeypress=\"enterSendedituserform(event)\">");
		out.println("<input id='Lastname' name='lastname' placeholder='Enter Last Name' type='text' onkeypress=\"enterSendedituserform(event)\">");
		out.println("<input id='Gender' name='gender' placeholder='Enter Gender (M/F)' type='text' onkeypress=\"enterSendedituserform(event)\">");
		out.println("<input id='Age' name='age' placeholder='Enter Age' type='text' onkeypress=\"enterSendedituserform(event)\">");
		out.println("<input id='City' name='city' placeholder='Enter City' type='text' onkeypress=\"enterSendedituserform(event)\">");
		out.println("<input id='Country' name='country' placeholder='Enter Country' type='text' onkeypress=\"enterSendedituserform(event)\">");
		out.println("<input id='Bio' name='bio' placeholder='Enter Bio' type='text' onkeypress=\"enterSendedituserform(event)\">");
		out.println("<p>Select an avatar: <select name='drop'></p>");
		...
		out.println("var firstname = document.getElementById('Firstname').value;");
		out.println("var lastname = document.getElementById('Lastname').value;");
		out.println("var bio = document.getElementById('Bio').value;");
		out.println("var gender = document.getElementById('Gender').value;");
		out.println("var age = document.getElementById('Age').value;");
		out.println("var city = document.getElementById('City').value;");
		out.println("var country = document.getElementById('Country').value;");
		out.println("  if (firstname.toString().trim() == '' || lastname.toString().trim() == '' || bio.toString().trim() == '' || gender.toString().trim() == '' || age.toString().trim() == '' || city.toString().trim() == '' || country.toString().trim() == '') {");
		out.println("    alert('No fields can be empty!');");
		out.println("    } else {");
		...
		out.println("  } ");
		out.println("} ");
		out.println("function enterSendnewroomform (event) { ");
		out.println("  if (event.keyCode == 13)");
		out.println("    {");
		out.println("    event.preventDefault();");
		out.println("    check_empty()");
		out.println("  }");
		out.println("} ");
		out.println("function enterSendpasswordform (event) { ");
		out.println("  if (event.keyCode == 13)");
		out.println("    {");
		out.println("    event.preventDefault();");
		...
		out.println("  }");
		out.println("} ");
		out.println("function enterSendsearchuserform (event) { ");
		out.println("  if (event.keyCode == 13)");
		out.println("    {");
		out.println("    event.preventDefault();");
		out.println("    submit_searchuser()");
		out.println("  }");
		out.println("} ");
		out.println("function enterSendedituserform (event) { ");
		out.println("  if (event.keyCode == 13)");
		out.println("    {");
		out.println("    event.preventDefault();");
		out.println("    submit_edituser()");
		out.println("  }");
		out.println("} ");
